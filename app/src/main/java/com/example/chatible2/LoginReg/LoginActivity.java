package com.example.chatible2.LoginReg;
...
import com.example.chatible2.ForgotPassword.ForgotPassActivity;
import com.example.chatible2.Home.MainActivity;
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                String userDeiceToken = FirebaseInstallations.getInstance().getToken(true).toString();
                                ...
                                SweetToast.error(LoginActivity.this, "Mật khẩu hoặc email của bạn bị sai! vui lòng kiểm tra lại.");
                            }
